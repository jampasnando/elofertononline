        ...
        @forEach($productos as $producto)
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                <div class="card product-card h-100">
                    <img src="{{$producto->img1 ? asset('storage/'.$producto->img1) : asset('imagenes/toolsplaceholder.png')}}" class="card-img-top open-product-modal"
                    alt="Taladro" style="height:150px; object-fit:cover;"
                    data-id="{{ $producto->id }}"
